    ...
    def get_data_as_dataframe(self):
          try:
                custom_data_input_dict={
                      ...
                      "family_history_with_overweight":[ self.family_history_with_overweight],"FAVC":[self.FAVC],
                      "FCVC":[self.FCVC],"NCP":[self.NCP],"CAEC":[self.CAEC],
                      "SMOKE":[self.SMOKE],"CH20":[self.CH20],"SCC":[self.SCC],
