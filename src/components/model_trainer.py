    ...
    def initiate_model_trainer(self,train_array,test_array):
        try:
            ...
            params={'LogisticRegression':{'max_iter':[100],'penalty':['l2']},
                     'RandomForest':{'n_estimators': [100],'max_depth':[13],'min_samples_split':[5],'random_state':[1]},
                     'GradientBoosting':{'n_estimators': [100],'max_depth':[13],'min_samples_split' :[5],'random_state':[1]}}
